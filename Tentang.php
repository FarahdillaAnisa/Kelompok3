...
<html lang="en">
  <head>
    <title>Tentang - Rumah Makan Awak</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel img" style="background-image: url(images/bg_1.jpg);">
      ...
      <div class="slider-item" style="background-image: url(images/About_rempah.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">

            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread">TENTANG AWAK</h1>
	            <p class="breadcrumbs"><span class="mr-2"><a href="beranda.php">Beranda Awak</a></span> <span>Tentang Awak</span></p>
            </div>
	    		...
	    		<div class="info">
	    			<div class="row no-gutters">
	    				<div class="col-md-4 d-flex ftco-animate">
	    					...
	    					<div class="text">
	    						<h3>(+62) 13288992</h3>
	    						<p>Sebuah rasa yang tetap bertahan</p>
	    					</div>
	    				</div>
	    				<div class="col-md-4 d-flex ftco-animate">
	    					...
	    					<div class="text">
	    						<h3>Jl. Sudirman</h3>
	    						<p>No.558 depan MTQ, Pekanbaru, Riau</p>
	    					</div>
	    				</div>
	    				<div class="col-md-4 d-flex ftco-animate">
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4">Assalamualaikum dan selamat datang di Rumah Makan<span> Awak</span> Sanak</h2>
        </div>
        <div>
  				<p>Rumah Makan Awak ko lah berdiri sejak tahun 1987, dari dulu awak berharap rumah makan ko tetap ado walau bersaing dengan masakan - masakan yang berado di zaman sekarang. Walapun zaman telah berubah tetapi Rumah Makan Awakko tetap samo rasonyo dengan raso yang asli walaupun zaman telah berubah, jadi awak hadir untuk bisa melestarikan dan mempertahankan masakan - masakan Indonesia dan tetap mengikuti perkembangan zaman tanpa mengurangi cita rasa dari makanannyo.</p>
  			</div>
    	</div>
    </section>
    ...
    <section class="ftco-section">
      <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">KOKI AWAK</h2>
            <p class="flip"><span class="deg1"></span><span class="deg2"></span><span class="deg3"></span></p>
            <p class="mt-5">Di balik bukit yang indah terdapat Air terjun yang tersembunyi, Begitu pula KOKI AWAK ko. Dibalik Dapur Rumah Makan Awak terdapat KOKI AWAK yang nan cantik dan gagah.</p>
          </div>
        </div>
        <div class="row">
        	...
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					...
      					<div class="text">
	        				<p>Awak disini sebagai Koki Rumah Makan Awak dan lebih spesifik bagian Profesional Dessert atau bahasa Awaknyo Makanan Pentup atau bisa juga makanan pencuci mulut.</p>
	        			</div>
      				</div>
        		</div>
        	</div>
        	...
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					...
      					<div class="text">
	        				<p>Awak disini sebagai Koki Rumah Makan Awak dan lebih spesifik bagian Pleating Makanan atau bahasa awak Tukang Menghias makanan sebelum di beri ke sanak yang mau makan.</p>
	        			</div>
      				</div>
        		</div>
        	</div>
